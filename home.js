...
heading.innerText="All Transactions";
    
    row.appendChild(heading);


let postCollection = document.querySelector("#posts-collection");
function createPost(title, category, information ,ipfs, type) {
    ...
    infoContainer.append(headingElement, paragraphElement, catElement, btnElement,z);
